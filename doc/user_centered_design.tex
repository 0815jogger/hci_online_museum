...
\begin{figure}[H]
	\centering
	\includegraphics[angle=0,scale=0.5]{iso_metric_diagram}
...
Bei dem Isometric Fragebogen zeigt die Auswertung, dass die Exceltabelle deutlich unterdurchnittliche Werte liefert. Im Vergleich zu anderen Werten aus den Vorlesungsfolien wird erkennbar, dass die Kennwerte nicht representativ für ein erflogversprechendes Projekt sind. Durch mangelnde Testpersonen wird ein stark verfälschtes Ergbnis erwartet. Dies bezieht sich ebenfalls auf den AttrakDiff Fragebogen. 
...
% nicht möglich aufgrund mangelnder Testdaten...
