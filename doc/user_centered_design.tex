...
Die hiermit verwendeten Auswertungskriterien beziehen sich auf die zentrale Tendenz, Variabilität und der Verteilungsform. Die zugrundeliegenden Erhebungswerte werden aus den Bögen des Isometric und des NasaTLX verwendet.
...
Mit dem AttrakDiff Fragebogen wurde die Beurteiling der Interaktionstechnik durchgefühht. Es wurde ebenso versucht die Qualität der Nutzererfahrung zu ermitteln. Vorallem war hier vordergründig die Nutzererfahrung im Zusammenspiel mit dem Tangible Interface interessant und ob das TI dem Nutzer einen Mehrwert bringt.

\begin{figure}[H]
	\centering
	\includegraphics[angle=0,scale=0.6]{attrakdiff_result}
	\caption{Ergebnis des AttrakDiff Fragebogens}
	\label{fig:result4}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[angle=0,scale=0.6]{attrakdiff_result2}
	\caption{Medianbildung des AttrakDiff Fragebogens}
	\label{fig:result5}
\end{figure}

Nach erstmaligem betrachten der Auswertung zeigt sich ein eher verhaltenes Ergebnis.

- AttrakDiff Fragebogen auswerten, begründen, dass wir "user experience" verwendet haben und das Tangible Interface


\subsection{Resultat}
Nach kritischer Betrachtung der Ergebnisse, scheint die Anwendung insgesamt mangelhaft.

- Diskutieren Sie die Ergebnisse mit Hinblick auf den Erfolg der Projektidee und mögliche Weiterentwicklungen.\\


- Dokumentieren und interpretieren Sie die Ergebnisse unter Bezugnahme auf Inhalte der Vorlesung
